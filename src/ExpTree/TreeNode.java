...
public class TreeNode implements Comparable<TreeNode>
{
	...
	private static TreeNode toLatexR(TreeNode working)
	{
		...
		TreeNode left;
		try
		{   //recursively simplify if right/left is an operator with 2 parameters
	...
	public static TreeNode solve(String s)
	{
		...
		return stepSimplify(convertToTree(convertToPost(s)), 5000);
	} //FIXME
	
	public static TreeNode softSolve(String s)
	{
		return convertToTree(convertToPost(s));
	}

...
public class mRule
{
	...
	static protected final mRule[] sRules = new mRule[]{
			...
			new mRule("M ^ N", "1/ (M ^ (-1 * N))"), //negative exponent rule
			...
			new mRule("log(M, X)", "log(10, X) / log(10, M)") //base change
	};
	...
	private mRule(String equation, String equalTo)
	{
		...
		this.delta = deltaScore(this.equation, this.equalTo);
	}
	
	public static int deltaScore(TreeNode n1, TreeNode n2)
	{
		return n2.getComplexity() - n1.getComplexity();
	}
	...
	protected boolean isIndependentVariable(String toTest, HashMap<String, TreeNode> varMap)
	{
